...
const cs225::HSLAPixel STEM_COLOR = color::GREEN;

const int LEAF_WIDTH = 16;
const int LEAF_HEIGHT = 16;
const cs225::HSLAPixel LEAF_COLOR = color::GREEN;

const int PISTIL_RADIUS = 12;
const cs225::HSLAPixel PISTIL_COLOR = color::YELLOW;

const int PETAL_RADIUS = 2;
const cs225::HSLAPixel PETAL_COLOR = color::RED;
...
void Flower::drawPetals(cs225::PNG* canvas, const Vector2& center, int x, int y) const
{
